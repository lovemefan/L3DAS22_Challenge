...
# @File : Crestormer.py
# conformer-restormer for speech enhancement of the L3DAS22 challenge.
...
##########################################################################
## Layer Norm
from example.models.ConformerEncoderLayer import ConformerBlock
...
##########################################################################
class ConformerBlockWithGDFN(nn.Module):
...
class Crestormer(nn.Module):
    def __init__(self,
        ...
        super(Crestormer, self).__init__()
